...
public class RocketParticleHandler : MonoBehaviour
{
     ...
     * also den Bereich des Partikelsystems, der die Emissionsrate (wie viele Partikel ausgesto�en werden) steuert.
     * Das EmissionModule wird verwendet, um zu kontrollieren, wie viele Partikel pro Sekunde erzeugt werden, 
     * was besonders bei der Anpassung der Partikelmenge n�tzlich ist.*/
    ...
    void Update()
    {
        //Verringert die particle �ber zeit
